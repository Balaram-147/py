...
if __name__ == "__main__":
    ...
    print(f"User 1 eligibility: {eligibility_service.check_eligibility(user1)}")  # Expected: True
    print(f"User 2 eligibility: {eligibility_service.check_eligibility(user2)}")  # Expected: False
